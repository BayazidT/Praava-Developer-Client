...
const LoginAPI = () => {
    const url ="GET https://ept.praavahealth.com/Admin/otp/createPhblOtp?token=<token>&upi=<upi>"
  return (
    <div className="login">
            <div className="title">Login</div>
            <div className='apiContent'>
                <div className="left">
                    <p>This endpoint login a patient to the portal.</p>
